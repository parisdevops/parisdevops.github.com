...
h2(#mixit). Slides de la présentation devops à la conférence MIX-IT
...
Dommage qu'il n'ait pas mentionné la finalité de devops, qui est finalement le plus important : une meilleure gestion de l'infrastructure et des applications pour une meilleure "expérience utilisateur" (pas d'utilisateur, pas d'IT ;-)
