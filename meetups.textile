...
L'un des principaux objectifs de _Paris DevOps_ est d'organiser des *meetups*, sous forme "d'open-spaces":/define/openspace.html (discussions en petit groupes) ou de présentations plus formelles, avec toujours un accent sur les *retours d'expérience*.
